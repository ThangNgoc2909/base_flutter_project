...
class _$_LoginState implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, isLoginButtonEnabled: $isLoginButtonEnabled, obscureText: $obscureText, isRemember: $isRemember)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password,
      isLoginButtonEnabled, obscureText, isRemember);
