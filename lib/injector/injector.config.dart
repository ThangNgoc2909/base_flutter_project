...
import 'package:base_project/base/base_rest_api/refresh_token_api_client.dart'
    as _i20;
import 'package:base_project/common/common_cubit/common_cubit.dart' as _i15;
...
import 'package:base_project/navigation/app_route_info/app_route_info_mapper.dart'
    as _i6;
import 'package:base_project/preferences/app_preferences.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i9.NoneAuthAppServerApiClient>(
        () => _i9.NoneAuthAppServerApiClient());
    ...
    gh.lazySingleton<_i13.AppPreferences>(
        () => _i13.AppPreferences(gh<_i10.SharedPreferences>()));
    gh.lazySingleton<_i14.AuthService>(
        () => _i14.AuthService(gh<_i9.NoneAuthAppServerApiClient>()));
    gh.factory<_i15.CommonCubit>(
        () => _i15.CommonCubit(gh<_i13.AppPreferences>()));
    gh.factory<_i16.LoginRepository>(
        () => _i17.LoginRepositoryImpl(gh<_i14.AuthService>()));
    gh.factory<_i18.AccessTokenInterceptor>(
        () => _i18.AccessTokenInterceptor(gh<_i13.AppPreferences>()));
    gh.factory<_i19.LoginCubit>(() => _i19.LoginCubit(
          gh<_i16.LoginRepository>(),
          gh<_i13.AppPreferences>(),
        ));
    ...
    gh.factory<_i22.RefreshTokenInterceptor>(() => _i22.RefreshTokenInterceptor(
          ...
          gh<_i9.NoneAuthAppServerApiClient>(),
        ));
