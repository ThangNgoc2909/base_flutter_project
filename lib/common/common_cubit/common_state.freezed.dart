...
abstract class $CommonStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, RemoteException? exception});
}
...
class _$_CommonState implements _CommonState {
  const _$_CommonState({this.isLoading = false, this.exception});
  ...
  @override
  String toString() {
    return 'CommonState(isLoading: $isLoading, exception: $exception)';
  }
...
abstract class _CommonState implements CommonState {
  const factory _CommonState(
      {final bool isLoading,
      final RemoteException? exception}) = _$_CommonState;
