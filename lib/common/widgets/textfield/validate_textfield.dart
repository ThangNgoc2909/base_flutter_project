      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIconConstraints:
              const BoxConstraints(minWidth: 5, minHeight: 5),
          isDense: true,
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(sp8),
            borderSide:
                const BorderSide(color: AppColors.borderColor_2, width: 1),
          ),
          errorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(sp8),
            borderSide: const BorderSide(color: AppColors.red_1, width: 1),
          ),
          ...
          contentPadding: widget.padding ??
              const EdgeInsets.symmetric(horizontal: sp12, vertical: sp16),
          isCollapsed: true,
