    ...
    return Column(
      ...
      children: [
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      //   '${AssetsPath.icon}/ic_arrow_left_calendar.svg',
                      // ),
                    ),
                  ),
                  Expanded(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      height: cellWidth,
                      // child: SvgPicture.asset(
                      //   '${AssetsPath.icon}/ic_arrow_right_calendar.svg',
                      // ),
                    ),
                  ),
                  const SizedBox(width: sp4),
        ...
        SfDateRangePicker(
          ...
          onSubmit: (value) {},
          rangeTextStyle:
              AppTypography.h5.copyWith(color: AppColors.whiteColor),
          ...
          rangeSelectionColor: AppColors.accentColor_3,
          yearCellStyle: DateRangePickerYearCellStyle(
            textStyle: AppTypography.h5.copyWith(color: AppColors.blackColor),
            todayTextStyle:
          ...
          monthCellStyle: DateRangePickerMonthCellStyle(
            ...
            trailingDatesTextStyle:
                AppTypography.h5.copyWith(color: AppColors.greyColor),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    "Xác nhận",
                    style:
                        AppTypography.p3.copyWith(color: AppColors.whiteColor),
                  ),
                ),
              ),
              const SizedBox(width: sp4),
